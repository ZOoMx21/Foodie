...
import com.example.foodie2.Models.ExtendedIngredient;
...
class IngredientsViewHolder extends RecyclerView.ViewHolder {
    ...
    public IngredientsViewHolder(@NonNull View itemView) {
        super(itemView);
        textView_ingred_quantity = itemView.findViewById(R.id.textView_ingredients_quantity);
        textView_ingred_name = itemView.findViewById(R.id.textView_ingredients_name);
        imageView_ingred = itemView.findViewById(R.id.imageView_ingredients);
    }
}